...
export async function GET({ locals }: any) {
    ...
    if (userDoc == null) {
        ...
        return new Response(JSON.stringify({ isSignedIn: true, wasJustCreated: true, me }), { headers: { "Content-Type": "application/json" } });
    }
    ...
    return new Response(JSON.stringify({ isSignedIn: true, wasJustCreated: false, me }), { headers: { "Content-Type": "application/json" } });
}