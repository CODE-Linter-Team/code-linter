import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './index2-af991d7a.js';
import { e as error, j as json, R as Redirect, H as HttpError, A as ActionFailure } from './index3-bebb4fa4.js';
import { w as writable, r as readable } from './index4-d46cba10.js';
...
class Server {
  ...
  async init({ env: env2 }) {
    ...
    if (!this.options.hooks) {
      const module = await import('./hooks.server-b120ad15.js');
      this.options.hooks = {
...
export { DEV as D, Server as S, env as e, override as o };
//# sourceMappingURL=index-bb115ea1.js.map
