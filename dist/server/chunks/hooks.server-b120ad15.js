import { D as DEV, e as env } from './index-bb115ea1.js';
import { S as SECRET_GOOGLE_ID, a as SECRET_GOOGLE_SECRET, b as SECRET_SERVICE_AUTH_SECRET, A as AUTH_SECRET, c as connectToDatabase } from './connectToDatabase-bd178207.js';
import { AuthHandler } from '@auth/core';
import Google from '@auth/core/providers/google';
import { U as User, A as Article, a as Asset } from './Asset.controller-c57bd65e.js';
...
import './index2-af991d7a.js';
import './index3-bebb4fa4.js';
import './index4-d46cba10.js';
import 'mongoose';
...
const isAlumniStatus = (s) => [
  "Graduate (alumn*)",
  "Techstart Alumni"
].includes(s?.[0] ?? "");
const toPerson = () => async (i) => {
...
const isStudent = (i) => isStudentStatus(i.props.Status) && i.props["Study program"]?.length > 0;
async function main() {
  ...
  await Promise.all(persons.map(UserController.createFromNotionImport));
}
config();
...
export { handle };
//# sourceMappingURL=hooks.server-b120ad15.js.map
